...
class ProtectedGallery: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    //Image UI code
    ...
    */
    ...
    func loadImages(){
        ...
        images.append(UIImage(named: "image11")!)
